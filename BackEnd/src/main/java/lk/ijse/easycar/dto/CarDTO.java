...
public class CarDTO {
    ...
    public CarDTO(String cr_reg, String cr_make, String cr_model, String cr_type, String cr_fuel, String cr_nfp, BigDecimal cr_day, BigDecimal cr_month, BigDecimal cr_km, Boolean cr_avail) {
        this.cr_reg = cr_reg;
        this.cr_make = cr_make;
        this.cr_model = cr_model;
        this.cr_type = cr_type;
